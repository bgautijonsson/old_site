...
```{r}
plot_dat |> 
    mutate(p = tekjur_alls / sum(tekjur_alls),
           p = percent(p, decimal.mark = ",", big.mark = "."),
           tekjur_a_mann = tekjur_alls / fjoldi_i_hop * 1e6 / 12,
           tekjur_a_mann = number(tekjur_a_mann, suffix = " kr", decimal.mark = ",", big.mark = "."),
           tekjur_alls = number(tekjur_alls, suffix = " mkr", decimal.mark = ",", big.mark = ".")) |> 
