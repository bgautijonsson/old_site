...
plot_dat <- d |> 
    ...
    mutate(undirvisitala = fct_reorder(undirvisitala, year_value, .fun = sum),
           text = str_c("Undirvísitala: ", undirvisitala, "\n",
                        "Ársáhrif: ", percent(year_value, accuracy = 0.01), "\n",
                        "Mánaðaráhrif: ", percent(value, accuracy = 0.01), "\n",
...
p <- plot_dat |> 
    ...
    geom_line(data = plot_dat |> 
                  ...
                  mutate(text = str_c("Vísitala samtals", "\n",
                                      "Árshækkun: ", percent(year_value, accuracy = 0.01), "\n",
                                      "Mánaðarhækkun: ", percent(value, accuracy = 0.01), "\n",
                                      "Dagsetning: ", format(date, "%B, %Y"))), 
              aes(group = "none")) +
