...
plot_dat |> 
    ...
    labs(x = NULL,
         y = NULL,
         title = "Þróun orkuframleiðslu á mann árin 1980 - 2018",
         caption = "Kóði og gögn: https://github.com/bgautijonsson/orkumal")
```
...
plot_dat |> 
    ...
    labs(x = NULL,
         y = NULL,
         title = "Þróun notkunar jarðefnaeldsneytis á mann árin 1980 - 2018",
         caption = "Kóði og gögn: https://github.com/bgautijonsson/orkumal")
```
...
plot_dat |> 
    ...
    labs(x = NULL,
         y = NULL,
         title = "Hlutfall orku frá jarðefnaeldsneytum árin 1990 - 2018",
         caption = "Kóði og gögn: https://github.com/bgautijonsson/orkumal")
```
...
plot_dat <- d |> 
    ...
    mutate(alpha = country %in% countries,
           ...
           y = case_when(country == "Iceland" ~ y * 1,
                         country == "Finland" ~ y * 1,
                         country == "Qatar" ~ y * 0.92,
                         country == "Denmark" ~ y * 1.01,
                         country == "New Zealand" ~ y * 1.13,
                         country == "United States" ~ y * 0.94,
                         country == "Venezuela" ~ y * 1,
                         country == "Germany" ~ y,
                         country == "Sweden" ~ y * 0.97,
                         country == "Norway" ~ y * 0.85,
                         TRUE ~ y)) |> 
    filter(year >= 1990, energy_per_gdp <= 6)
